...
\documentclass[german, 11pt, a4paper]{awesome-cv} % A4 paper size by default, use 'letterpaper' for US letter
...
\name{Taha Dhiaeddine}{Amdouni}
\address{Milbertshofener Straße 44, 80807 München, Deutschland}
\mobile{(+49)-173-5939609}

\email{me@amdouni.com}
\homepage{amdouni.de}
\twitter{tdamdouni}
\github{tdamdouni}
%\skype{skypeid}
...
\position{Software Engineer{\enskip\cdotp\enskip}IT Consultant} % Your expertise/fields
\quote{"Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Taha Dhiaeddine Amdouni~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
